  ...
  return (
    <SafeAreaView className="flex-1 bg-white-50">
      <View style={{ padding: spacing.lg }}>
        ...
        <View className="items-center mb-12">
          ...
          <View className="items-center">
            <Text
              ...
              className="text-black-300 text-center w-[300px]"
            >
              {t('auth.signUpText')}
            </Text>
          </View>
        ...
        {/* Form Section */}
        <View className="">
          <View className="items-center space-y-6 gap-8">
        ...
        {/* Footer Section */}
        <View className="flex-row justify-center items-end gap-x-[10px] mt-56">
